...
//        addView(background, layoutParamsView);
        ...
        disabledDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_lock_outline_black_24dp);
        enabledDrawable = ContextCompat.getDrawable(getContext(), R.drawable.complete);

        slidingButton.setImageDrawable(disabledDrawable);
        slidingButton.setPadding(8, 8, 8, 8);
        ...
        layoutParamsButton.setMargins(16, 0, 0, 0);
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (active) {
                            ...
                            if (slidingButton.getX() + slidingButton.getWidth() > getWidth() * 0.100) {
                                expandButton();
                            } else {
                                moveButtonBack();
                            }
...
//                slidingButton.setImageDrawable(enabledDrawable);
                swipeButtonStateChangeListener.onButtonStateChange(active);
            }
        });
    ...
    private OnSwipeButtonStateChangeListener swipeButtonStateChangeListener;

    public void setOnSwipeButtonStateChangeListener(OnSwipeButtonStateChangeListener listener) {
        this.swipeButtonStateChangeListener = listener;
    }

    public interface OnSwipeButtonStateChangeListener {
        void onButtonStateChange(boolean active);
    }
